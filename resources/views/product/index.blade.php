 ...
 <div class="py-12">
     <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
         <div class="bg-red-800 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                 ...
                 <div class="p-6 text-gray-900 dark:text-gray-100">
                     ...
                     <fieldset class="border p-2 mb-2 border-black rounded">
                         ...
                         <form action="{{ route('product.store') }}" method="POST">
                             ...
                             <div class="grid gap-2 grid-cols-2 mb-2">
                                 ...
                                 <div class="mt-4">
                                     <x-input-label for="category" :value="__('Categoria')" class="text-lg"> Selecione uma categoria</x-input-label>
                     ...
                     <div>
                         ...
                         <form action="{{ route('product.index') }}" method="GET">
                             ...
                             <x-primary-button class="bg-green-600 border-green-900" @click="showProduct = false">Pesquisar</x-primary-button>
                         </form>
